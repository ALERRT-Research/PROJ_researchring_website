...
We use [Namecheap](https://www.namecheap.com){target="_blank"}. The recommended approach is to buy one **primary domain** and a few **secondary domains** that redirect to it — this covers common spelling variations and prevents someone else from squatting on them.
...
These are GitHub Pages' current IP addresses. They rarely change, but you can verify them in the [GitHub Pages documentation](https://docs.github.com/en/pages/configuring-a-custom-domain-for-your-github-pages-site/managing-a-custom-domain-for-your-github-pages-site){target="_blank"}.
