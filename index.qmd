...
::: {.column width="30%"}
[![Click to visit ActiveAttackData.org](resources/aade_screenshot.png)](https://activeattackdata.org/){target="_blank"}
:::
::::::
...
::: {.column width="30%"}
[![Click to visit the Tactical Science Substack](resources/transparent_crosshair.png)](https://tacticalscience.substack.com/){target="_blank"}
:::
::::::
